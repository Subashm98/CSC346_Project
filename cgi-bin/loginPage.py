        ...
        <div class="card card-4">
            <div class="card-body">
                ...
                <form method="POST" action=auth.py>
                    ...
                    <div class="p-t-15">
                        <button class="btn btn--radius-2 btn--blue" type="submit" value="Submit" name="regbtn">Register</button>
                    </div>
                </form>
            </div>
        </div>
            ...
            <div class="card-body">
                ...
                <form method="POST">          <!-- <form action="/action_page.php"> -->
                    ...
                    <div class="container">
                        ...
                        <button class="btn btn--radius-2 btn--blue" type="submit" value="Submit" name="logbtn">Login</button>
                    </div>
